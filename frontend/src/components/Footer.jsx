          ...
          <div className="md:text-right">
            ...
            <div className="mt-6 flex items-center gap-4 md:justify-end">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full bg-cream/10 text-cream transition-colors hover:bg-clay hover:text-white"
              >
                <svg
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-cream/10 text-cream transition-colors hover:bg-emerald-600 hover:text-white"
              >
                <svg
                  className="h-5 w-5 fill-current"
                  viewBox="0 0 24 24"
